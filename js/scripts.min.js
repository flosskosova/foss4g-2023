...
d<=e&&0<=d&&a(".track-header.sticky").find(".slot-detail").html(a(this).data("slotDetail"))})});a(window).resize(function(){1500<a(window).width()?a(".effect-wrapper").addClass("col-lg-2"):a(".effect-wrapper").removeClass("col-lg-2");768>a(window).width()?(a(".same-height").css("height","100%"),a(".timeslot-label").addClass("stick-label")):(a(".timeslot-label").removeClass("stick-label"),c.hasClass("st-menu-open")&&(c.removeClass("st-menu-open"),a("body").css("overflow","auto")),equalheight(".same-height"));
